...
define("can/view/stache/text_section",["can/util/util","can/view/live/live","can/view/stache/utils","can/view/stache/live_attr"],function(t,e,n,i){e=e||t.view.live;var s=function(){this.stack=[new r]},a=function(){};t.extend(s.prototype,n.mixins),t.extend(s.prototype,{startSection:function(t){var e=new r;this.last().add({process:t,truthy:e}),this.stack.push(e)},endSection:function(){this.stack.pop()},inverse:function(){this.stack.pop();var t=new r;this.last().last().falsey=t,this.stack.push(t)},compile:function(n){var s=this.stack[0].compile();return function(c,r){var u=t.compute(function(){return s(c,r)},this,!1,!0);u.bind("change",a);var o=u();u.computeInstance.hasDependencies?(n.attr?e.simpleAttribute(this,n.attr,u):i.attributes(this,u,c,r),u.unbind("change",a)):n.attr?t.attr.set(this,n.attr,o):e.setAttributes(this,o)}}});var c=function(t,e,n){return function(i,s){return t.call(this,i,s,e,n)}},r=function(){this.values=[]};return t.extend(r.prototype,{add:function(t){this.values.push(t)},last:function(){return this.values[this.values.length-1]},compile:function(){for(var t=this.values,e=t.length,n=0;e>n;n++){var i=this.values[n];"object"==typeof i&&(t[n]=c(i.process,i.truthy&&i.truthy.compile(),i.falsey&&i.falsey.compile()))}return function(n,i){for(var s,a="",c=0;e>c;c++)s=t[c],a+="string"==typeof s?s:s.call(this,n,i);return a}}}),s});
